...
import { ResultModal, Selection } from ".";
    ...
    <>
      <StForm>
        ...
        <StBtnWrapper>
          ...
          <StButton type="button" disabled={btnDisabled} onClick={handleClickButton}>
            {price}원 구매하기
          </StButton>
        </StBtnWrapper>
      </StForm>
      {isModalOpen && <ResultModal optionSelected={optionSelected} onCloseModal={handleClickButton} />}
    </>
  );
}
